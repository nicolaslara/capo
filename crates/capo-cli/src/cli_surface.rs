...
Usage:
  ...
  capo server agent register --name NAME [--adapter fake --runtime fake] [--request REQUEST_ID] [--client CLIENT_ID] [--actor ACTOR] [--state PATH]
  capo server agent list [--request REQUEST_ID] [--client CLIENT_ID] [--actor ACTOR] [--state PATH]
  capo server agent status --agent NAME [--request REQUEST_ID] [--client CLIENT_ID] [--actor ACTOR] [--state PATH]
  capo server task send --agent NAME --goal GOAL [--scenario NAME] [--request REQUEST_ID] [--client CLIENT_ID] [--actor ACTOR] [--state PATH]
  capo server dashboard [--recent-events N] [--request REQUEST_ID] [--client CLIENT_ID] [--actor ACTOR] [--state PATH]
  capo server recover [--request REQUEST_ID] [--client CLIENT_ID] [--actor ACTOR] [--state PATH]
