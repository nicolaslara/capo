...
use capo_state::{
    AdapterSmokeReportProjection, ArtifactRecord, CapabilityGrantProjection,
    ConnectivityExposureProjection, EventKind, EventRecord, EvidenceProjection,
    ...
    RunProjection, RuntimeTargetProjection, SessionProjection, SqliteStateStore,
...
use adapter_launch::{
    DispatchPlanRecordRequest, DispatchPromptSourceInput, adapter_readiness, plan_adapter_launch,
    recordable_adapter_dispatch_plan, render_adapter_dispatch_plan, validate_local_launch_adapter,
};
