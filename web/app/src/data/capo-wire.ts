 ...
 *
 * COPIED VERBATIM from `crates/capo-server/contract/capo-wire.d.ts`. Adopt the
 * generated types here rather than re-declaring the wire shape inline; if the
 * contract evolves, re-copy this file. The web client consumes the SSE event
 * tail (`EventNotification` / `CapoEvent`) via these types.
 *
