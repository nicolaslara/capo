...
- CLI connectivity exposure validation and regression coverage: `../../crates/capo-cli/src/main.rs`
- Runtime target read model used by validation: `../../crates/capo-state/src/lib.rs`
- Runtime/connectivity architecture source: `../architecture/runtime-tunnel.md`
- Remote runtime source workpad: `remote-runtime.md`
- No new third-party dependencies were added for RR12.

## F7/RR13 Runtime Target Endpoint Consistency

Observed 2026-05-26.

- CLI runtime-target endpoint validation and regression coverage: `../../crates/capo-cli/src/main.rs`
- Runtime target read model used by validation: `../../crates/capo-state/src/lib.rs`
- Runtime/connectivity architecture source: `../architecture/runtime-tunnel.md`
- Remote runtime source workpad: `remote-runtime.md`
- No new third-party dependencies were added for RR13.

## F7/RR14 Runtime Target Availability Guard

Observed 2026-05-26.

- CLI runtime-target availability validation and regression coverage: `../../crates/capo-cli/src/main.rs`
- Runtime target status read model used by validation: `../../crates/capo-state/src/lib.rs`
- Runtime/connectivity architecture source: `../architecture/runtime-tunnel.md`
- Remote runtime source workpad: `remote-runtime.md`
...
- Shared exact/latest adapter smoke report selectors and regression coverage: `../../crates/capo-query/src/lib.rs`
- CLI `capo adapter smoke-report status` parser, rendering, and regression coverage: `../../crates/capo-cli/src/main.rs`
- Adapter smoke report projection stored by state layer: `../../crates/capo-state/src/lib.rs`
- Agent connectors source workpad: `agent-connectors.md`
...
- SQLite schema and projection-table reset helper module: `../../crates/capo-state/src/schema.rs`
...
- Projection read-model apply module: `../../crates/capo-state/src/apply.rs`
...
- Tool wrapper command module: `../../crates/capo-cli/src/tool_wrapper.rs`
- Governed wrapper implementations remain in: `../../crates/capo-tools/src/runtime_wrappers.rs`
